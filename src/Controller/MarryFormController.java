...
public class MarryFormController implements Initializable {

    public JFXTextField txtSearch;
    public JFXButton btnNew;
    public TableView<MCTM> tblMarrySearch;
 ...
 if (event.getCode()==KeyCode.ENTER){
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        tblMarrySearch.getColumns().get(0).setCellValueFactory(new PropertyValueFactory<>("docNo"));
        tblMarrySearch.getColumns().get(1).setCellValueFactory(new PropertyValueFactory<>("name1"));
        tblMarrySearch.getColumns().get(2).setCellValueFactory(new PropertyValueFactory<>("name2"));
        tblMarrySearch.getColumns().get(3).setCellValueFactory(new PropertyValueFactory<>("name3"));
        ...
        txtSearch.textProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                ...
                try {
                    ...
                    ObservableList<MCTM> items = tblMarrySearch.getItems();


                    while (rst.next()) {
                        items.add(new MCTM(rst.getString(1),
                                rst.getString(3),
                                rst.getString(4),
                                rst.getString(5)));
                    }
